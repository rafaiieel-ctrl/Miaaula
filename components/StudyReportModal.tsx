    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
                <div className="flex flex-col items-center animate-fade-in space-y-8 max-w-md mx-auto pb-4">
            ...
            {/* Footer */}
            <div className="p-6 border-t border-white/5 bg-[var(--q-surface)] shrink-0 z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.3)]">
                <button 
                    onClick={onClose}
                    className="w-full max-w-md mx-auto bg-white text-slate-950 font-black py-5 rounded-[2rem] shadow-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-xs"
                >
